    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class=" nav-item">
        <a class="d-flex align-items-center" href="#">
          ...
          <span class="menu-title text-truncate" data-i18n="User">Admin</span>
        </a>
          <ul class="menu-content">
              <li>
                <a class="d-flex align-items-center" href="{{url('/user')}}">
                <i data-feather="user"></i>
                <span class="menu-item text-truncate" data-i18n="Collapsed Menu">User</span>
              </a>
              </li>
              <li>
                <a class="d-flex align-items-center" href="{{route('role')}}">
                <i data-feather="circle"></i>
                <span class="menu-item text-truncate" data-i18n="Layout Full">Role</span>
              </a>
              </li>
              <li>
                <a class="d-flex align-items-center" href="{{route('permission')}}">
                <i data-feather="circle"></i>
