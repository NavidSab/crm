    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a
                    type="button"
                    class="btn btn-success waves-effect waves-float waves-light" href="{{ route('document.create') }}">
            ...
            <div class="table">
                <table class="table ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $document->id }}</td>
                            <td><img width="30%" src="{{ $document->document }}" alt="{{  $document->id }}"></td>
                            <td>
                                <div class="dropdown">
                                    <button
                                        type="button"
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{ route('document.edit',$document->id) }}">
                                           ...
                                           <form id="delete-form" action="{{ route('document.destroy',$document->id) }}" method="POST" class="d-none">
                                            @csrf
                                            </form>
