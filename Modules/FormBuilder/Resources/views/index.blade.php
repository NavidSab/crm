                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{ route('form.createItem',$form->id) }}">
                                        ...
                                        <form id="delete-form-{{ $form->id }}" action="{{ route('form.destroy',$form->id) }}" method="POST" class="d-none">
                                           ...
                                           <a class="dropdown-item"  href="javascript:void(0)" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $form->id }}').submit();"><i data-feather="trash" class="me-50"></i>Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
