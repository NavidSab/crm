              ...
              <div class="row">
                <div class="col-md-3 col-12">
                  <div class="mb-1">
                    ...
                    <input type="text" id="from_date" class="form-control pickadate" placeholder="18 June, 2020" />
                  </div>
                </div>
                <div class="col-md-3 col-12">
                  <div class="mb-1">
                ...
                <div class="col-md-3 col-12">
                  <div class="mb-1">
                    ...
                    <label class="foform-label" for="department_id">Department</label>
                    <select class="select2 form-select" id="department_id" multiple="multiple">
                ...
                <div class="col-md-3 col-12">
                  <div class="mb-1">
                    ...
                    <input type="file" id="first-name-column" class="form-control" placeholder="Name" name="name" required>
