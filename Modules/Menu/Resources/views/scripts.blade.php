...
<script type="text/javascript" src="{{Module::asset('menu:scripts.js')}}"></script>
<script type="text/javascript" src="{{Module::asset('menu:scripts2.js')}}"></script>
<script type="text/javascript" src="{{Module::asset('menu:menu.js')}}"></script>